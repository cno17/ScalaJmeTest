...
object Test2 extends SimpleApp:

  type Font = TrueTypeFont[GlyphMesh, TrueTypeMeshText]
  ...
  override def init() =
    ...
    val font = assetManager.loadAsset(key).asInstanceOf[Font]
    val sc = StringContainer(font, str)
