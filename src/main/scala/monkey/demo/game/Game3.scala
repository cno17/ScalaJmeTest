...
object Game3 extends SimpleApp:

  var dLight: DirectionalLight = null
  var pLight: PointLight = null
  var sLight: SpotLight = null
  // var cameraController: KinematicCameraController = null

  override def init() =
    createScene(500, 500, 3000)
  ...
  // cameraController = KinematicCameraController(this)
